...
NUMBER_OF_OPS_LU_SMALL=$((($SIZE_OF_SMALL * SIZE_OF_SMALL * SIZE_OF_SMALL + SIZE_OF_SMALL * SIZE_OF_SMALL + SIZE_OF_SMALL) * $LU_LOOP));
NUMBER_OF_OPS_LU_BIG=$((($SIZE_OF_BIG * SIZE_OF_BIG * SIZE_OF_BIG + SIZE_OF_BIG * SIZE_OF_BIG + SIZE_OF_BIG) * $LU_LOOP));

NUMBER_OF_OPS_ADD_SMALL_SSE=$(($SIZE_OF_SMALL_SSE * $SIZE_OF_SMALL_SSE * $ADD_LOOP));
NUMBER_OF_OPS_ADD_BIG_SSE=$(($SIZE_OF_BIG_SSE * $SIZE_OF_BIG_SSE * $ADD_LOOP));
NUMBER_OF_OPS_MULT_SMALL_SSE=$(($SIZE_OF_SMALL * SIZE_OF_SMALL_SSE * SIZE_OF_SMALL_SSE * 2 * $MULT_LOOP));
NUMBER_OF_OPS_MULT_BIG_SSE=$(($SIZE_OF_BIG_SSE * SIZE_OF_BIG_SSE * SIZE_OF_BIG_SSE * 2 * $MULT_LOOP));
...
#execute
       ...
       #multiplication matrice big multiplication $MULT_LOOP iterations with float and openmp
               ...
               { time ./target/debug/test_matrix_big m $MULT_LOOP f < test_mat.txt ; } 2>> perfs.txt;
               echo "done";
       #factorisation LU matrice big multiplication $MULT_LOOP iterations with floats and openmp
               echo "" >> perfs.txt;
               echo "factorisation LU matrice big factorisationLU "$LU_LOOP" iterations with floats and openmp : "$NUMBER_OF_OPS_LU_BIG" operations" >> perfs.txt;
               echo "factorisation LU matrice big factorisationLU "$LU_LOOP" iterations with floats and openmp : "$NUMBER_OF_OPS_LU_BIG" operations";
               { time ./target/debug/test_matrix_big f $LU_LOOP f < test_mat.txt ; } 2>> perfs.txt;
               echo "done";
               echo "" >> perfs.txt;
       #factorisation LU matrice small multiplication $MULT_LOOP iterations with floats and openmp
               echo "factorisation LU matrice big factorisationLU "$LU_LOOP" iterations with floats and openmp : "$NUMBER_OF_OPS_LU_SMALL" operations" >> perfs.txt;
               echo "factorisation LU matrice big factorisationLU "$LU_LOOP" iterations with floats and openmp : "$NUMBER_OF_OPS_LU_SMALL" operations";
               { time ./target/debug/test_matrix_small f $LU_LOOP f < test_mat.txt ; } 2>> perfs.txt;
               echo "done";
               echo "#########        END OF TEST      #########" >> perfs.txt;
               echo "" >> perfs.txt;
...
unset SIZE_OF_SMALL;
unset SIZE_OF_BIG;
unset SIZE_OF_SMALL_SSE;
unset SIZE_OF_BIG_SSE;
unset NUMBER_OF_OPS_ADD_SMALL;
unset NUMBER_OF_OPS_ADD_BIG;
unset NUMBER_OF_OPS_MULT_SMALL;
unset NUMBER_OF_OPS_MULT_BIG;
unset NUMBER_OF_OPS_ADD_SMALL_SSE;
unset NUMBER_OF_OPS_ADD_BIG_SSE;
unset NUMBER_OF_OPS_MULT_SMALL_SSE;
unset NUMBER_OF_OPS_MULT_BIG_SSE;
unset NUMBER_OF_OPS_LU_SMALL;
unset NUMBER_OF_OPS_LU_BIG;
